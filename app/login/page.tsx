      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-2xl border-0">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-blue-900">{t("auth.signIn")}</CardTitle>
            <p className="text-blue-600">{t("auth.signInSubtitle")}</p>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="bg-white px-2 text-sm text-blue-600">{t("auth.orContinueWith")}</span>
              </div>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm text-blue-600">
                {t("auth.noAccount")}{" "}
                <Link href="/signup" className="font-medium text-blue-900 hover:text-amber-600">
                  {t("auth.signUp")}
                </Link>
              </p>
            </div>
        ...
        <div className="text-center mt-6 text-blue-200 text-sm">
          <p>{t("auth.trustedBy")}</p>
          <p>🔒 {t("auth.secureData")}</p>
        </div>
      </div>
    </div>
  )
